...
## Obraz (https://centrala.ag3nts.org/dane/i/rynek.png):
Nieznany obraz, brak opisu.

## Obraz (https://centrala.ag3nts.org/dane/i/rynek_glitch.png):
Nieznany obraz, brak opisu.

## Obraz (https://centrala.ag3nts.org/dane/i/fruit01.png):
Podczas pierwszej próby transmisji materii w czasie użyto truskawki.

## Obraz (https://centrala.ag3nts.org/dane/i/fruit02.png):
Podczas pierwszej próby transmisji materii w czasie użyto truskawki.

## Obraz (https://centrala.ag3nts.org/dane/i/strangefruit.png):
Nieznany obraz, brak opisu.

## Obraz (https://centrala.ag3nts.org/dane/i/resztki.png):
Resztki pizzy.

## Audio (https://centrala.ag3nts.org/dane/i/rafal_dyktafon.mp3):
No i co teraz No to teraz mi już nie powstrzyma cię jesteśmy tutaj sami i trzeba tylko wykonać plan jak ja się do tego nie zmieszczę w sumie dobrze zaplanowałem poszerzenie Adam miał rację jedna informacja powinna w czasie jedna informacja 2 lata wcześniej posunie całe badania do przodu i wtedy już będzie z górki na odwagę z truskawką bo nie wyszło ale ale jedna myślą była ale ale Adam mówi że to jest stabilne że to się wszystko uda Trzeba tylko cofnąć się w czasie 119 hotel ile ma być hoteli w Grudziądzu ja nie wiem ale na pewno znajdę 1 i potem czekać spokojnie czekać 2 lat tyle jestem w stanie zrobić resztę mam zapisane na kartce No to co No to super wpisujemy Czekaj czekaj koordynaty są Grudziądz dobra Batman nie wchodzi Dobra a jest w menu człowiek Dobra wszystko jeszcze w tych klinik a wezmę ze sobą trochę dobra jestem gotowy jeszcze jedno na odwagę tak inaczej się tobie dobra naciskamy Czekamy to idź szybciej Ile można czekać

**Bomba chciał znaleźć hotel w Grudziądzu.**


## Kluczowe informacje:
- Użyty owoc podczas pierwszej próby transmisji materii w czasie: **Truskawka**.
- Resztki jedzenia znalezione w pobliżu komory temporalnej: **Pizza**.
